...
class Logic:
    ...
    def map_law(self):
        if self.check_Phat != True:
            if self.Phat_y >= self.ground_y-50:
                self.Phat_y = self.Loc_y = self.Huong_y = self.Tu_y = self.ground_y-50
                self.GRAVITY = 0
                self.mon_return()
            elif self.Phat_y <= 0:
            ...
            if self.Loc_y >= self.ground_y-50:
                self.Loc_y = self.Huong_y = self.Tu_y = self.ground_y-50
                self.GRAVITY = 0
                self.mon_return()
            elif self.Loc_y <= 0:
            ...
            if self.Huong_y >= self.ground_y-50:
                self.Huong_y = self.Tu_y = self.ground_y-50
                self.GRAVITY = 0
                self.mon_return()
            elif self.Huong_y <= 0:
            ...
            if self.Tu_y >= self.ground_y-50:
                self.Tu_y = self.ground_y-50
                self.GRAVITY = 0
                self.mon_return()
            elif self.Tu_y <= 0:
                self.Tu_y = 0
    ...
    def logic_colli(self, Character, check, cha_x):
        ...
        if self.block1_check:
            if Character.colliderect(self.block1):
                ...
                elif self.block1_image!=self.map.image1 or self.block1_image!=self.map.image5:
        ...
        if self.block2_check:
            if Character.colliderect(self.block2):
                ...
                elif self.block2_image!=self.map.image1 or self.block2_image!=self.map.image5:
                    self.check_character_lose(check)
        ...
        if self.block3_check:
            if Character.colliderect(self.block3):
                ...
                elif self.block3_image!=self.map.image1 or self.block3_image!=self.map.image5:
                    self.check_character_lose(check)
    ...
    def logic_variable_definition(self):
        ...
        self.block3_check=True
        self.check_mouse=True
        self.ground_y=self.setting.playscreen_ground_y
